...
export default function EpisodeAlert({ id }: { id: string }) {
  return (
    <>
      <section className="m-sm:mt-[30px] break-keep">
        <article className="max-w-[768px] mx-auto m-sm:px-5 m-sm:flex m-sm:justify-between m-sm:items-center m-sm:gap-6">
          <ul>
						...
						<EpisodeAlertEnd id={id} />
					</ul>
        </article>

				<article className="max-w-[768px] mx-auto mt-5 m-sm:px-5">
					<ul>
						<li className="min-h-12 mb-3 p-3 rounded-[10px] flex justify-between items-center bg-gray-50">
							...
							<div className="flex flex-col gap-2 items-end">
								<p className="text-[12px] font-normal text-gray-500">Lecture gratuite dans <span className="font-semibold text-red-500">12</span> h!</p>
