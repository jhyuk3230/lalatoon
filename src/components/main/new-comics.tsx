								...
								<SwiperSlide key={i} className="w-[210px]">
									<Link href={e.link} className="block">
										<div className="pb-[100%] rounded-[10px] relative overflow-hidden">
											<Image src={`https://thumb-g1.lalatoon.com/upload/thumbnail/20240627135437/2024_07_04_17200546332316.jpg`} alt={`#`} width={500} height={100} className="w-full absolute top-0 left-0" />
